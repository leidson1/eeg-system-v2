// Lista de Cidades do Tocantins para autocomplete
...
// Médicos Solicitantes padrão (podem ser adicionados nas configurações)
export const MEDICOS_SOLICITANTES_DEFAULT = [
    "Dr. José Silva",
    "Dra. Maria Santos",
    "Dr. Carlos Oliveira",
]

// Médicas Executoras padrão
export const MEDICAS_EXECUTORAS_DEFAULT = [
    "Dra. Graziela Schiavoni",
]

// Enfermeiras padrão
export const ENFERMEIRAS_DEFAULT = [
    "Lucy Pinheiro",
]
